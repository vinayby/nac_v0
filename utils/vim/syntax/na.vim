...
" A bunch of useful na keywords
"
syn keyword	cStorageClass	 __reg__ __bram__ __ram__ parameter
syn keyword	cStatement	send scatter gather recv display pe broadcast barrier  halt
syn keyword	cLabel		as on from to task taskgroup 
syn keyword	cConditional	if else 
syn keyword	cRepeat		loop parallel group
